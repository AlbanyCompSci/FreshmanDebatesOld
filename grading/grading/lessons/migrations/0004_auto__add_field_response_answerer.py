...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.answerer'
        db.add_column(u'lessons_response', 'answerer',
    ...
    def backwards(self, orm):
        # Deleting field 'Response.answerer'
        db.delete_column(u'lessons_response', 'answerer_id')
